...
namespace TootTallyLeaderboard.GameplayModifier
{
    public static class GameModifierManager
    {
        ...
        static void OnLevelSelectControllerStartPostfix(LevelSelectController __instance)
        {
            ...
            _modifierPanel = LeaderboardFactory.CreateDefaultPanel(__instance.fullpanel.transform, new Vector2(-35, 60), new Vector2(300, 200), "ModifierPanel");
